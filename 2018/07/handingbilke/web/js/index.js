define(function(require, exports, module) {
    'use strict';
    require('/zt/common/web/js/swiper/2.7.5/swiper');
   ...
   var arr = ['wb', 'wxgzh', 'pcx', 'app', 'wxq', 'qqq', 'wbtw', 'wxqfx'];
    ...
    var GET_VERIFY = '//item.diandong.com/passport/ark/sendVerifyCode';
    var SUBMIT_FORM = '//item.diandong.com/passport/ark/joinbmkj';
    var SUBMIT_FORM_YX = '//item.diandong.com/passport/clientapi/wishadd';
    var TOPENERGYLIST = '//item.diandong.com/globals/wsjoin/top';
    var article = {
        init: function() {
  ...
  s.parentNode.insertBefore(hm, s);
            ...
            var userAgent = /Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)
              if(userAgent){
window.location.href="//zhuanti.diandong.com/zt/2018/07/handingbilke/mobile/index.html?idfa="+ idfa
              } 
        ...
        word: function(parent) {
            var inps = $(obj.bargain).find('input')
            var len = inps.length
             var a = 1;
             inps.each(function(index,el) {
                $(el).on('keyup',function() {
                    ...
                    if(val){
                        $(this).data('words',index+1);
                       if($(obj.carType).data('words')){
                        if($(obj.name).data('words')){
                            if($(obj.mobile).data('words')){
                                if($(obj.verify).data('words')){
                                    $(obj.sumitForm).addClass(obj.submitBefore)
                                }
                            }
                        }
                       }
        ...
        submitFrom: function() {
            ...
            $(obj.sumitForm).on('click', function() {
                if(!$(obj.sumitForm).hasClass(obj.submitBefore)) return;
