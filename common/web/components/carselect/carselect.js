 ...
 * @date 2015/10/12
 * @param elements{ brand:<品牌元素jq对象>, series:<车系元素jq对象>, model:<车型元素jq对象>}
 * @param status: <"onSale(在售）","onProduct(在产)","all(全部)">
 */
define(function (require, exports, module) {
    var Carselect, api, constants, elements;
